...
- A 320px las cuatro etiquetas de la barra inferior ("Captura", "Visualización", "Movimientos", "Configuración") suman ~312px a 14px y se tocan entre sí. No produce scroll (la barra es `position: fixed`) pero es una decisión de UX/tipografía del shell (SPEC-00): reducir a 12px bajo 360px, abreviar o usar iconos. A 375px caben.
